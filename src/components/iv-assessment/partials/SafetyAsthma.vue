<template>
  <div
    ...
    :class="{
      'group--error':
        v.section_1_client_questionnaire.B_safety_contraindications.history_asthma.$error ||
        v.section_1_client_questionnaire.B_safety_contraindications.asthma_control_if_yes.$error ||
        v.section_1_client_questionnaire.B_safety_contraindications.asthma_inhaler_if_yes.$error ||
        v.section_1_client_questionnaire.B_safety_contraindications.asthma_er_if_yes.$error,
    }"
  >
    <p
      ...
      :class="{
        'text-negative':
          v.section_1_client_questionnaire.B_safety_contraindications.history_asthma.$error ||
          v.section_1_client_questionnaire.B_safety_contraindications.asthma_control_if_yes
            .$error ||
          v.section_1_client_questionnaire.B_safety_contraindications.asthma_inhaler_if_yes
            .$error ||
          v.section_1_client_questionnaire.B_safety_contraindications.asthma_er_if_yes.$error,
      }"
    >
