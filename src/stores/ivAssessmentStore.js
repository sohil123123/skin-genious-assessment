...
export const useIVAssessmentStore = defineStore('iv-assessment', {
  ...
  actions: {
    ...
    setPatientData(data) {
      ...
      this.formData.meta.profile.name = data.first_name + ' ' + data.last_name
      this.formData.meta.profile.gender = data.gender
      this.formData.meta.profile.age = useCommonStore().getAgeFromDate(data.date_of_birth)
    },
    setData(data) {
