    ...
    section_1_client_questionnaire: {
      ...
      C_recent_exposures_24_72h: {
        ...
        alcohol_last_drink_if_high: {
          required: requiredIf(() => {
            const b = formData.value.section_1_client_questionnaire.C_recent_exposures_24_72h
      ...
      D_symptoms_today: {
        ...
        muscle_cramps_type_if_yes: {
          required: requiredIf(() => {
            const b = formData.value.section_1_client_questionnaire.D_symptoms_today
      ...
      E_medications_supplements: {
        ...
        bp_meds_taken_today: {
          required: requiredIf(() => {
            const b = formData.value.section_1_client_questionnaire.E_medications_supplements
        ...
        current_supplements: {
          ...
          magnesium_taken_24h: {
            required: requiredIf(() => {
              const b =
                formData.value.section_1_client_questionnaire.E_medications_supplements
                  .current_supplements
      ...
      G_acute_metabolic_status: {
        ...
        females_only: {
          ...
          first_day_of_last_menstrual_period_date: {
            required: requiredIf(() => {
              const f =
                formData.value.section_1_client_questionnaire.G_acute_metabolic_status.females_only
              const gender = formData.value.meta.profile.gender
      ...
      H_iv_access_procedure_tolerance: {
        ...
        fainting_frequency: {
          required: requiredIf(() => {
            const b = formData.value.section_1_client_questionnaire.H_iv_access_procedure_tolerance
